...
def run_test_sum_of_digits():
    ...
    # Test 2:
    expected = 16
    answer = sum_of_digits(2347)
    print('Test 2 expected:', expected)
    print('       actual:  ', answer)

    # Test 3
    expected = 29
    answer = sum_of_digits(8849)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)

    # Test 4
    expected = 17
    answer = sum_of_digits(485)
...
def digits_in_cube(n):
    ...
    # -------------------------------------------------------------------------
    digit_cubed = n**3
    value = sum_of_digits(digit_cubed)
    return value
...
def digits_in_power(n, k):
    ...
    digit_powered = n**k
    new_sum = sum_of_digits(digit_powered)
    return new_sum
